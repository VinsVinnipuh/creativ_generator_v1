...
async def _get_file_path(message: Message, context: ContextTypes.DEFAULT_TYPE) -> str:
...
async def handle_photo(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    file_path = await _get_file_path(update.message, context)
    brief.image_paths.append(file_path)
...
def generate_creatives(client: OpenAI, model: str, brief: UserBrief, variants: int) -> str:
    ...
    for image_path in brief.image_paths:
...
async def generate(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if not brief.texts and not brief.image_paths:
        await update.message.reply_text(
